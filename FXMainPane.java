...
public class FXMainPane extends VBox {
	...
	DataManager dataManagerInst = new DataManager();
	...
	class handler implements EventHandler<ActionEvent> {
		...
		public void handle(ActionEvent event) {
			...
			if (t == button1) {
				...
				txtField.setText(dataManagerInst.getHello());

			} else if (t == button2) {

				txtField.setText(dataManagerInst.getHowdy());

			} else if (t == button3) {

				txtField.setText(dataManagerInst.getChinese());
